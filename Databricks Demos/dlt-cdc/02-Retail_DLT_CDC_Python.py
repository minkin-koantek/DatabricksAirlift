...
# MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&cid=4994874874414839&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Fdata-engineering%2Fdlt-cdc%2F02-Retail_DLT_CDC_Python&uid=6165859300088079">
...
# MAGIC
# MAGIC Your pipeline has been created! You can directly access the <a dbdemos-pipeline-id="dlt-cdc" href="/#joblist/pipelines/0f2b4277-e5f1-4b92-98a6-4ed4019d2a33">Delta Live Table Pipeline for CDC</a>.
...
# MAGIC %md
# MAGIC ## Conclusion 
# MAGIC We now have <a dbdemos-pipeline-id="dlt-cdc" href="/#joblist/pipelines/0f2b4277-e5f1-4b92-98a6-4ed4019d2a33">our DLT pipeline</a> up & ready! Our `customers` table is materialize and we can start building BI report to analyze and improve our business. It also open the door to Data Science and ML use-cases such as customer churn, segmentation etc.
...
# MAGIC
# MAGIC <a href="/sql/dashboards/19ea4d1a-75bd-447f-af3e-a6245d0066e4" target="_blank">Data Quality Dashboard</a>
