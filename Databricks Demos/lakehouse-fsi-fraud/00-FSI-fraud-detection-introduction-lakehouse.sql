...
-- MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&cid=4994874874414839&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Flakehouse%2Flakehouse-fsi-fraud%2F00-FSI-fraud-detection-introduction-lakehouse&uid=6165859300088079">
...
-- MAGIC %md 
-- MAGIC Open the FSI banking & Fraud  <a dbdemos-pipeline-id="dlt-fsi-fraud" href="#joblist/pipelines/926a193d-8dc2-4b27-99ef-17566e30cdc6" target="_blank">Delta Live Table pipeline</a> or the [SQL notebook]($./01-Data-ingestion/01.1-DLT-fraud-detection-SQL) *(Alternatives: DLT Python version Soon available)*. <br>
...
-- MAGIC %md 
-- MAGIC Open the [Datawarehousing notebook]($./03-BI-data-warehousing/03-BI-Datawarehousing-fraud) to start running your BI queries or access or directly open the <a href="/sql/dashboards/46e43a8c-4449-4b33-b109-a3dcfdebea5d" target="_blank">Banking fraud analysis dashboard</a>
