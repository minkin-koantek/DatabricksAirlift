...
# MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&cid=4994874874414839&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Flakehouse%2Flakehouse-fsi-credit%2F03-Data-Science-ML%2F03.1-Feature-Engineering-credit-decisioning&uid=6165859300088079">
...
# MAGIC   *
# MAGIC FROM
# MAGIC   fsi_credit_decisioning.customer_gold_features
# MAGIC WHERE
...
customer_gold_features = (spark.table("customer_gold_features")
                               ...
                               .select('cust_id', 'education', 'marital_status', 'months_current_address', 'months_employment', 'is_resident',
                                       ...
                                       'total_UT', 'customer_revenue', 'age', 'avg_balance', 'num_accs', 'balance_usd', 'available_balance_usd'))
...
fund_trans_gold_features = spark.table("fund_trans_gold_features")
