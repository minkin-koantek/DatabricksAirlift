...
# MAGIC %fs ls mnt/dbacademy-datasets/apache-spark-programming-with-databricks/v03//ecommerce/users/users-500k.csv

# COMMAND ----------

# MAGIC %fs ls dbfs:/mnt/dbacademy-datasets/apache-spark-programming-with-databricks/v03/ecommerce/events/events-500k.json

# COMMAND ----------

# MAGIC %fs head dbfs:/mnt/dbacademy-datasets/apache-spark-programming-with-databricks/v03/ecommerce/events/events-500k.json/part-00000-tid-309888144738233288-fab86c62-ff9f-4176-98c6-587f95ee9066-2365-1-c000.json

# COMMAND ----------

# MAGIC %fs head dbfs:/mnt/dbacademy-datasets/apache-spark-programming-with-databricks/v03/ecommerce/users/users-500k.csv/part-00000-tid-6798248775191304424-0020915c-5cd2-4aae-8903-2d586d002073-2359-1-c000.csv
...
help(events_df.schema)

# COMMAND ----------

event_ddl = events_df.schema.simpleString
...
.option("location",users_output_dir).saveAsTable("events_external"))
...
# MAGIC %sql
# MAGIC
# MAGIC DESCRIBE EXTENDED events_external
...
display(dbutils.fs.ls(f"{DA.paths.working_dir}/delta/events"))
